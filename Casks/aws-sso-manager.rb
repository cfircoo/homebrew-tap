cask "aws-sso-manager" do
  ...
  url "https://github.com/cfircoo/aws-sso-manager/releases/download/v#{version}/AWS.SSO.Manager-#{version}-arm64.dmg",
  ...
  homepage "https://github.com/cfircoo/aws-sso-manager"
